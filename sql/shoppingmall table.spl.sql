...
INSERT INTO SHOP_ITEM (ITEM_NAME, ITEM_PRICE, ITEM_INTRO, ITEM_STOCK, ITEM_STATUS, CATE_CODE) 
VALUES 
('IT', 10000, 'IT 책', 15, 'FOR_SALE', 1),
('에세이', 10000, '에세이 책', 30, 'FOR_SALE', 2),
('에세이2', 15000, '에세이2 책', 10, 'FOR_SALE', 2),
('IT2', 15000, 'IT2 책', 25, 'FOR_SALE', 1),
('자기개발', 10000, '자기개발 책', 5, 'FOR_SALE', 3);


INSERT INTO SHOP_ITEM (ITEM_NAME, ITEM_PRICE, ITEM_INTRO, ITEM_STOCK, ITEM_STATUS, CATE_CODE)
VALUES ('IT', 10000, 'IT 책', 15, 'FOR_SALE', 1);
